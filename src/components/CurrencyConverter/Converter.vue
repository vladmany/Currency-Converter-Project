    ...
    <div id="converter-form">
        <div class="conv-wrapper">
            <div class="input-form">
                <select @change="convert(),switchCounterCurrency(inputSelect)" v-model="inputSelect" class="dropdown">
                    <option>EUR</option>
                    <option>USD</option>
                    <option>UAH</option>
                    <option>RUB</option>
            ...
            <div class="switch-form">
                <button @click="switchData(),convert()">⇄</button>
            </div>
            <div class="output-form">
                <select @change="convert()" v-model="outputSelect" class="dropdown">
                    <option>EUR</option>
                    <option>USD</option>
                    <option>UAH</option>
                    <option>RUB</option>
